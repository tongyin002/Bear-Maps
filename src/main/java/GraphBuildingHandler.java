...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            lastVertex = new Vertex(id, lon, lat);
...
//            System.out.println("Beginning a way...");
            ...
            nodeIdList.add(Long.parseLong(attributes.getValue("ref")));
            ...
            if (k.equals("maxspeed")) {
                ...
                validHighway = ALLOWED_HIGHWAY_TYPES.contains(v);
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            ...
            if(name.length() >= 1) {
                Location loc = new Location(lastVertex.id, lastVertex.lon, lastVertex.lat, attributes.getValue("v"));
                g.locationTST.put(name, loc);
                if(!g.locations.containsKey(name)) {
                    g.locations.put(name, new ArrayList<Location>());
                }
                g.locations.get(name).add(loc);
            }
        }
    }
...
//            System.out.println("Finishing a way...");
            if (validHighway) {
                g.addEdge(lastWayId, nodeIdList, lastWayName);
            }
            nodeIdList.clear();
            validHighway = false;
            lastWayName = "unknown road";
