...
public class MapServer {
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        ...
        Iterable<String> locs = graph.locationTST.keysWithPrefix(prefix);
        for(String name : locs) {
            ans.add(graph.locationTST.get(name).name);
        }
        return ans;
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        ...
        for (Location loc : graph.locations.get(GraphDB.cleanString(locationName))) {
